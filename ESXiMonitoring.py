###########################################################################################################################
#	By default ESXi 6.5 hosts have CIM disabled. 
#	Details here: http://www.squidworks.net/2017/02/vmware-esxi-6-5-cim-data-disabled-by-default/ 
#	To enable CIM on these hosts: 
# 
#	ssh onto ESXi host (enable SSH on the host if needed)
#	esxcli system wbem set --enable true
#	/etc/init.d/sfcbd-watchdog start
#	
#	ssh onto Nagios monitoring server
#	# Installs PIP and its requirements 
...
#	
#	# Upgrades pywbem
#	/usr/local/bin/pip install pywbem --upgrade 
#	
###########################################################################################################################


#Below this line is taken directly from: https://www.claudiokuenzler.com/nagios-plugins/check_esxi_hardware.py
